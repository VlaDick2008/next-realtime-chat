...
const ConversationsList: React.FC<ConversationsListProps> = ({ initialItems, users, title }) => {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed inset-y-0 pb-12 lg:pb-0 lg:left-20 lg:w-80 lg:block overflow-y-auto border-r border-gray-200',
